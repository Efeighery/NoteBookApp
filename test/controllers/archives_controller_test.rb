...
class ArchivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create archive" do
    assert_difference("Archive.count") do
      post archives_url, params: { archive: { full_name: @archive.full_name, note_space: @archive.note_space, note_title: @archive.note_title } }
    end
  ...
  test "should update archive" do
    patch archive_url(@archive), params: { archive: { full_name: @archive.full_name, note_space: @archive.note_space, note_title: @archive.note_title } }
